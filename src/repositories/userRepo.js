...
async function insert(user) {
  await pool.query(
    `INSERT INTO users
       (id,name,email,role,password,country,"isVerified",status,avatar,profile,
        "isSubscribed","subscriptionPlan","subscriptionExpiry","rejectionReason","createdAt","updatedAt")
